...
var (
	...
	// ErrBuyerServiceUnknown is returned when the repository returns an unknown error (not defined in repository errors)
	ErrBuyerServiceUnknown = errors.New("service: unknown error")
)
